...
const GROUPS: { title: string; links: { to: string; label: string; icon: typeof Receipt }[] }[] = [
  {
    ...
    links: [
      ...
      { to: "/verification", label: "Vérification des reçus", icon: ShieldCheck },
  ...
  },
  {
    ...
    links: [
      ...
      { to: "/caisse", label: "Caisse et mouvements", icon: Wallet },
      { to: "/cloture", label: "Clôture de caisse", icon: Lock },
    ],
  },
  {
