  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Un problème est survenu. Essayez de rafraîchir ou revenez à l'accueil.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cahier Pro — Gestion commerciale" },
      {
        name: "description",
        content:
          "Cahier Pro remplace le cahier de comptes papier : ventes, clients, stock, dettes et bénéfices en HTG.",
      },
      { property: "og:title", content: "Cahier Pro — Gestion commerciale" },
      {
...
function RootComponent() {
  ...
  useEffect(() => {
    const stored = typeof localStorage !== "undefined" ? localStorage.getItem("cp-theme") : null;
    const prefersDark =
